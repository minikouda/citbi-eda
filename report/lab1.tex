...
\title{Lab 1 --- Exploratory Data Analysis of the PECARN\\
Pediatric Traumatic Brain Injury Dataset\\
\large STAT 214, Spring 2026}
\author{Anonymous}
\date{}
...
I pledge that all analysis, writing, and code in this report is my own work.
Every external source I consulted---including Kuppermann et al.---is cited in the bibliography.
I did not share code with or copy any portion of the write-up from other students.
Where I used computational tools for assistance, the intellectual direction of the analysis,
the interpretation of findings, and the written narrative are entirely my own.

Academic research honesty is necessary because science is a cumulative enterprise built on trust.
If results are fabricated, plagiarized, or data are manipulated, subsequent researchers and
practitioners build on a false foundation.
In the medical domain this is not abstract: clinicians applying a flawed decision rule to real
patients can cause direct harm.

% ─────────────────────────────────────────────────────────────
\section{Collaborators}
\label{collaborators}

No collaborators to acknowledge.
